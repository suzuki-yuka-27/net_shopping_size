class Bottom < ApplicationRecord
  ...
  attribute :waist, :float, default: 0
  attribute :hip, :float, default: 0
  attribute :rising_length, :float, default: 0
  attribute :inseam, :float, default: 0
  attribute :total_length, :float, default: 0
  attribute :thickness_of_thigh, :float, default: 0
  attribute :bottom_width, :float, default: 0
end
